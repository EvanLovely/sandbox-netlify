...
cmd="$netlifycli deploy --site-id sandbox-netlify.netlify.com --base-directory dist --yes --message $deploy_message"
...
curl --silent  \
     ...
     https://api.netlify.com/api/v1/sites/sandbox-netlify.netlify.com/deploys | node <<< "var o = $(cat); console.log(JSON.stringify(o[0], null, 4));"
